...
const widths=document.getElementsByClassName('widthAdjust')
widths[3].style.width=50+'px'
widths[5].style.width=20+'px'
widths[4].style.width=43+'px'
for(let i=0;i<=widths.length-4;i++){widths[i].style.width=20+'px'}}
